...
export default function OnSale({ items, staticPath, index }) {
    ...
    return (
        <>
            <div className='w-[100%] h-[auto] hover:shadow-2xl shadow-lg duration-100 hover:mt-[-5px]'>
                <img className='w-[100%] h-[200px] object-cover' src={staticPath + productImage} />
                <div className='text-center p-[15px]'>
                    <p className='py-[5px] text-gray-500 text-[14px]'>{parentCategory.categoryName}</p>
                    <h3 className='border-b-[1px] border-gray-200 hover:rounded-[50px] rounded-[10px] pb-[10px]'>{productName}</h3>
