    ...
    return (
        <div className='w-[100%]'>
            ...
            <div className='max-w-[1320px] mx-auto mb-[10px] lg:p-[0px] p-[15px]'>
                <img className='w-[100%] lg:h-[80vh] h-[40vh]' src='https://wscubetech.co/Assignments/furniture/storage/app/public/uploads/images/home-page/983cc349-1718-4290-b7cd-c8eb20459536-1671213069.jpg' />
            ...
            <div className='max-w-[1320px] mx-auto mb-[10px]'>
                ...
                <div className='grid lg:grid-cols-3 grid-cols-1 md:grid-cols-2 justify-center  gap-[10px] flex-wrap'>
                    <div className='flex flex-col items-center justify-center p-[10px] my-[30px]'>
                        <img src='https://wscubetech.co/Assignments/furniture/storage/app/public/uploads/images/why_choose_us/c65c4789-c1eb-4cfc-9961-3ab025317e08-1670161041.jpg' />
            ...
            <div className='max-w-[1320px] mx-auto lg:my-[50px] cursor-grab'>
                <Slider {...settings} id="homeSlider">
                    <div className=''>
                        ...
                        <img className='w-[100px] mx-auto rounded-[50%]' src='https://wscubetech.co/Assignments/furniture/storage/app/public/uploads/images/testimonial/35b5a0a0-e80f-4038-a75a-2811de92118b-1670161614.png' />
                        <h4 className='mt-[10px] text-center'>Kathy Young</h4>
                        <p className='text-center my-[10px]'>CEO of SunPark</p>
                    </div>
                    <div className=''>
                        <p className='text-center my-[10px]'>These guys have been absolutely outstanding. Perfect Themes and the best of all that you have many options to choose! Best Support team ever! Very fast responding! Thank you very much! I highly recommend this theme and these people!</p>
                        <img className='w-[100px] mx-auto rounded-[50%]' src='https://wscubetech.co/Assignments/furniture/storage/app/public/uploads/images/testimonial/c6381687-5a5e-4914-9373-9cbec4937be6-1670161604.jpg' />
                        <h4 className='mt-[10px] text-center'>Kathy Young</h4>
                        <p className='text-center my-[10px]'>CEO of SunPark</p>
                    </div>
                    <div className=''>
                        <p className='text-center my-[10px]'>These guys have been absolutely outstanding. Perfect Themes and the best of all that you have many options to choose! Best Support team ever! Very fast responding! Thank you very much! I highly recommend this theme and these people!</p>
                        <img className='w-[100px] mx-auto rounded-[50%]' src='https://wscubetech.co/Assignments/furniture/storage/app/public/uploads/images/testimonial/3023f95a-ce85-434c-b9c5-2b0943b865e2-1670161621.jpg' />
                        <h4 className='mt-[10px] text-center'>Kathy Young</h4>
                        <p className='text-center my-[10px]'>CEO of SunPark</p>
                    </div>
                </Slider>
